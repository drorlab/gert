...
def custom_collate(data_list):
    ...
    elements_1 = pad_sequence([atom_env.elements for atom_env in batch_1]).permute(1, 0, 2)
    ...
    elements_2 = pad_sequence([atom_env.elements for atom_env in batch_2]).permute(1, 0, 2)
