...
from models.heads import EqvRSRFeedForward
...
def train_eqv_rsr(ex, use_attention, data_dir, device, log_dir, checkpoint, num_epochs, batch_size, num_dense,
    ...
    ff_model = EqvRSRFeedForward(Rs_hidden, Rs_ff, Rs_out, max_radius, number_of_basis, h, L).to(device)
